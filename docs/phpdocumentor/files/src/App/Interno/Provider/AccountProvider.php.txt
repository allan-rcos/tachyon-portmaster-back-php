 ...
 */
/**
 * Builds the self-service account use cases.
 *
 * Every use case here acts on the caller themselves, so none declares a
 * permission and none is handed the registrar — the only feature slice of which
 * that is true.
 *
 ...
 * @see UserProvider The administrative counterpart, which is guarded.
...
{
    /**
     * Builds the {@see IGetAccountUseCase} implementation.
     *
     * @copyright 2026 Tachyon
     */
    ...
    /**
     * Builds the {@see IUpdateAccountUseCase} implementation.
     *
     * @copyright 2026 Tachyon
     */
    ...
    /**
     * Builds the {@see IChangePasswordUseCase} implementation.
     *
     * @copyright 2026 Tachyon
     */
