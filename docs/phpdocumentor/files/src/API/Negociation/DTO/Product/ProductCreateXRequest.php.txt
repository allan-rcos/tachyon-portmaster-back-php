...
/**
 * Product Create Request Message.
 *
 * @category API
 *
...
/**
 * A product being registered.
 *
 * @see ProductCreateXRequestFactory What builds this from a request body.
 *
 * @license {@link https://opensource.org/licenses/MIT MIT}
 * @copyright 2026 Tachyon
 */
final readonly class ProductCreateXRequest
{
    /**
