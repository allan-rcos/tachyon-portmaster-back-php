 ...
 *
 * @see EnvSource The typed reader the links use.
 * @see BootDraft What the links fill in.
 *
 * @license {@link https://opensource.org/licenses/MIT MIT}
 * @copyright 2026 Tachyon
 */
final class DotEnvStarter
{
     ...
     *
     * The chain runs to completion rather than stopping at the first problem, so
     * a failure names **every** invalid variable at once — one boot attempt is
     * enough to see the whole list.
     *
     * @param  string  $dir  Directory to look for a `.env` file in.
     * @return LeafContext|BootConfig The complete configuration, or the context
     *                                listing the variables that failed.
     *
     * @copyright 2026 Tachyon
     *
     * @api
     ...
     * Assembles the chain.
     *
     * Order is irrelevant — the links are independent and each fills its own
     * slot — so new groups can simply be appended.
     *
     * @return Chain\DotEnvChain The head link, with the rest behind it.
     *
     * @copyright 2026 Tachyon
     */
