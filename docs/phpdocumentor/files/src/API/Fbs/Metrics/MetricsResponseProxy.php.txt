...
final class MetricsResponseProxy extends MetricsResponse implements IFbsProxy
{
     ...
     * @param  int  $totalContainers  Containers on record, dispatched ones included.
     * @param  float  $yardLoad  How full the yard is overall.
     * @param  int  $registeredProducts  Products in the catalogue.
     * @param  ?OccupancyDivisionProxy  $occupancyDivision  The container count broken down by status.
     *
     * @copyright 2026 Tachyon
     */
     ...
     *
     * @param  MetricsResponse  $table  The generated table to read.
