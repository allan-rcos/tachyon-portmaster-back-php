...
/**
 * JSON/binary-aware proxy around the generated {@see ProductUpdateRequest} table.
 *
 ...
 * @copyright 2026 Tachyon
 */
final class ProductUpdateRequestProxy extends ProductUpdateRequest implements IFbsProxy
{
    use CoercesJson;
    ...
    public function buildInto(FlatbufferBuilder $builder): int
    {
        ...
        return ProductUpdateRequest::createProductUpdateRequest($builder, $name, $this->density, $this->riskClass->toInt());
    }
     ...
     *
     * @param  ProductUpdateRequest  $table  The generated table to read.
     ...
     * @api
     */
    public static function fromTable(ProductUpdateRequest $table): static
    {
        return new static(
            name: $table->getName(),
    ...
    {
        return static::fromTable(ProductUpdateRequest::getRootAsProductUpdateRequest(ByteBuffer::wrap($binary)));
    }
