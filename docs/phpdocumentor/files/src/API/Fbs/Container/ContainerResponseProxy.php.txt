...
final class ContainerResponseProxy extends ContainerResponse implements IFbsProxy
{
     ...
     * @param  ?string  $code  The code identifying the physical container.
     * @param  float  $currentWeight  What the container currently holds, in kilograms.
     * @param  float  $maxCapacity  Capacity ceiling, in kilograms.
     * @param  ContainerStatus  $status  HTTP status code.
     *
     * @copyright 2026 Tachyon
     */
     ...
     *
     * @param  ContainerResponse  $table  The generated table to read.
