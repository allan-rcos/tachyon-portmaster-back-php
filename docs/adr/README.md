...
| [0002](0002-metadata-registries-in-the-database.md) | Metadata registries in the database, not `OpenSwoole\Table` |
| [0003](0003-engine-memory-for-runtime-tables.md) | `ENGINE=MEMORY` for permissions and markers |
