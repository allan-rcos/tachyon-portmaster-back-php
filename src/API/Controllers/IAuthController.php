 ...
 *
 * The only unauthenticated controller, necessarily: every action here runs
 * before — or in order to end — a session, so none of them can resolve a caller
 * first, and none of the use cases behind them declares a permission.
 *
 * @see IProductController The contract shape these follow.
 * @see \API\Auth\ITokenService What mints and verifies the tokens.
 *
 * @license {@link https://opensource.org/licenses/MIT MIT}
 * @copyright 2026 Tachyon
 */
