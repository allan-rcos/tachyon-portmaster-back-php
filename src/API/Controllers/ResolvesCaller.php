 ...
 * the use case.
 *
 * @see Session What actually reads the caller.
 * @see \API\Controllers\Interno\ProductController The action shape this opens.
 *
 * @license {@link https://opensource.org/licenses/MIT MIT}
 * @copyright 2026 Tachyon
 */
trait ResolvesCaller
{
     ...
     *
     * @return Result<UserContext> The caller's context, or a 401.
     *
     * @copyright 2026 Tachyon
     */
     ...
     *                                                             HTTP request.
     * @return string The base62 id, or an empty string.
     *
     * @copyright 2026 Tachyon
     */
