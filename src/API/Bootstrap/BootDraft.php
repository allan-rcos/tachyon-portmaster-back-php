 ...
 *
 * @see \API\Bootstrap\Chain\DotEnvChain The links that fill it in.
 * @see DotEnvStarter What runs the chain and freezes the result.
 *
 * @license {@link https://opensource.org/licenses/MIT MIT}
 * @copyright 2026 Tachyon
 */
final class BootDraft
{
    ...
    /**
     * The failure for a group no link contributed.
     *
     * @param  string  $group  Name of the empty slot.
