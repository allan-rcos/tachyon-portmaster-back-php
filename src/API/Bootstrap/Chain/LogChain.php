...
/**
 * Reads the logging variable into a {@see LogConfig}.
 *
...
{
    /**
     * Fills the draft's `log` slot from `LOG_LEVEL`.
     *
     * @param  EnvSource  $env  Reader over the loaded environment.
     * @param  BootDraft  $draft  Accumulator to write the logging group into.
     *
     * @copyright 2026 Tachyon
     */
