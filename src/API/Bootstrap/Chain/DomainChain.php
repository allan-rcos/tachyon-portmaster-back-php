...
/**
 * Reads the snowflake variables into a {@see DomainConfig}.
 *
...
{
    /**
     * Fills the draft's `domain` slot from `SNOWFLAKE_EPOCH` and
     * `SNOWFLAKE_MACHINE_ID`.
     *
     * @param  EnvSource  $env  Reader over the loaded environment.
     * @param  BootDraft  $draft  Accumulator to write the domain group into.
     *
     * @copyright 2026 Tachyon
     */
