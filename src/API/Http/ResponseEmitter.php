 ...
 *
 * @see AuthCookie What builds the values this has to preserve.
 *
 * @license {@link https://opensource.org/licenses/MIT MIT}
 * @copyright 2026 Tachyon
 */
...
{
    /**
     * Writes status, headers and body onto the OpenSwoole response and ends it.
     *
     * @param  SwooleResponse  $response  The server's response handle.
     * @param  ResponseInterface  $psrResponse  What the middleware stack produced.
     *
     * @copyright 2026 Tachyon
     *
     * @api
     ...
     * than guessed at. A value with no `name=value` pair at all is dropped.
     *
     * @param  SwooleResponse  $response  The server's response handle.
     * @param  string  $header  One `Set-Cookie` value to re-apply.
     *
     * @copyright 2026 Tachyon
     */
