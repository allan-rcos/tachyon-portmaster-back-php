 ...
 *
 * The table is the only place a URL appears. Routing to the *interface* rather
 * than a concrete controller is what keeps it that way: this file names no
 * implementation, so swapping one changes nothing here.
 *
 * @see \API\Http\Middleware\RouteDispatchMiddleware What matches against this.
 * @see \API\Interno\ApiProvider What resolves the matched interface.
 *
 * @license {@link https://opensource.org/licenses/MIT MIT}
 * @copyright 2026 Tachyon
 */
final class Routes
{
    ...
    /**
     * Builds the dispatcher over the whole route table.
     *
