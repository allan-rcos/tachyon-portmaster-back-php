...
/**
 * Account Password Change Request Proxy.
 *
 * @category API
 *
...
final class AccountPasswordChangeRequestProxy extends AccountPasswordChangeRequest implements IFbsProxy
{
     ...
     *
     * @param  ?string  $currentPassword  The existing password, which must be presented to change it.
     ...
     *
     * @param  AccountPasswordChangeRequest  $table  The generated table to read.
