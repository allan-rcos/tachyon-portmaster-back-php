...
class TokenUser extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return TokenUser
     */
    public static function getRootAsTokenUser(ByteBuffer $bb)
    {
        $obj = new TokenUser();
     ...
     * @return void
     */
    public static function startTokenUser(FlatbufferBuilder $builder)
    {
     ...
     * @return int
     */
    public static function createTokenUser(FlatbufferBuilder $builder, $id, $name, $email, $roles)
    {
        $builder->startObject(4);
     ...
     */
    public static function endTokenUser(FlatbufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }
