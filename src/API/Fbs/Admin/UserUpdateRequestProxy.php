...
/**
 * JSON/binary-aware proxy around the generated {@see UserUpdateRequest} table.
 *
 ...
 * @copyright 2026 Tachyon
 */
final class UserUpdateRequestProxy extends UserUpdateRequest implements IFbsProxy
{
    use CoercesJson;
     ...
     *
     * @param  UserUpdateRequest  $table  The generated table to read.
     ...
     * @api
     */
    public static function fromTable(UserUpdateRequest $table): static
    {
        return new static(
            name: $table->getName(),
    ...
    {
        return static::fromTable(UserUpdateRequest::getRootAsUserUpdateRequest(ByteBuffer::wrap($binary)));
    }
