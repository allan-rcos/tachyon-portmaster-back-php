...
/**
 * JSON/binary-aware proxy around the generated {@see SetupRequest} table.
 *
 ...
 * @copyright 2026 Tachyon
 */
final class SetupRequestProxy extends SetupRequest implements IFbsProxy
{
    use CoercesJson;
    ...
    public function buildInto(FlatbufferBuilder $builder): int
    {
        ...
        return SetupRequest::createSetupRequest($builder, $name, $email, $password);
    }
     ...
     *
     * @param  SetupRequest  $table  The generated table to read.
     ...
     * @api
     */
    public static function fromTable(SetupRequest $table): static
    {
        return new static(
            name: $table->getName(),
    ...
    {
        return static::fromTable(SetupRequest::getRootAsSetupRequest(ByteBuffer::wrap($binary)));
    }
