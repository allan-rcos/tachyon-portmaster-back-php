...
final class OccupancyDivisionProxy extends OccupancyDivision implements IFbsProxy
{
     ...
     * @param  int  $loading  Containers still taking cargo.
     * @param  int  $sealed  Containers closed but not yet dispatched.
     * @param  int  $inTransit  Containers dispatched.
     *
     * @copyright 2026 Tachyon
     */
     ...
     *
     * @param  OccupancyDivision  $table  The generated table to read.
