...
final class PDOConfigFactory
{
     ...
     *                           schema's `utf8mb4`.
     * @param  array<string, mixed>  $options  Extra PDO attributes. Note that
     *                                         the error mode set here does not
     *                                         survive — {@see PooledPDOClient}
     *                                         forces exceptions on every handle
     *                                         it lends out.
