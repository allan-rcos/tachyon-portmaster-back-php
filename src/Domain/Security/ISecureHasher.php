 ...
 * and both make it useless as a lookup key: {@see hash()} is not reproducible,
 * so the only way to match a value is {@see verify()} against a digest you
 * already hold — {@see IIndexHasher} is the flavour for keys.
 */
