...
/**
 * Moves a marker's flag, enforcing single-use semantics.
 *
 * Declares no permission and takes no {@see \App\Context\UserContext}: markers
 * are infrastructure for whoever issued the value being flagged, and the callers
 * that use them — the refresh flow above all — are the ones deciding whether
 * anybody is authenticated at all.
 *
 * @see SetMarkerCommand What it takes.
 * @see \App\Services\Interno\SetMarkerUseCase The implementation.
 * @see IGetMarkerUseCase The read side.
 *
 * @license {@link https://opensource.org/licenses/MIT MIT}
 * @copyright 2026 Tachyon
 */
interface ISetMarkerUseCase
{
     ...
     *
     * @param  SetMarkerCommand  $command  The group, the value, the requested
     *                                     flag and the TTL.
