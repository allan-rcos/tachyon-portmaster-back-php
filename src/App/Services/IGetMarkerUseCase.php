...
interface IGetMarkerUseCase
{
     ...
     * live". `false` (consumed) and an empty result (expired, or never existed) are
     ...
     * @return Result<bool> The flag, or {@see Result::void()} when no live
     *                       marker matched; 404 when the group is not
     *                       registered, 422 when the value is empty.
     *
     * @copyright 2026 Tachyon
     *
     * @api
