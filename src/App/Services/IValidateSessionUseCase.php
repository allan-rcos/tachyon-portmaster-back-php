...
/**
 * Validate Session Use Case Contract.
 *
 ...
 *
 * @see \App\Services\Interno\ValidateSessionUseCase The implementation.
 * @see ILoginUseCase The other pre-authentication use case.
 *
 * @license {@link https://opensource.org/licenses/MIT MIT}
 * @copyright 2026 Tachyon
 */
...
{
    /**
     * Re-reads the user the claims name, and answers with the current truth.
     *
     * Takes a bare {@see UserContext} rather than a query object — it is not
     * reached from a controller, but from the authentication middleware, which
     * has no command to build.
     *
