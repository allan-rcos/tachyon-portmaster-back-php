 ...
 * to update this.
 *
 * @see SetupCommand What it takes.
 * @see \App\Services\Interno\SetupUseCase The implementation.
 * @see ILoginUseCase The other door that opens without a caller.
 *
 * @license {@link https://opensource.org/licenses/MIT MIT}
 * @copyright 2026 Tachyon
 */
...
{
    /**
     * Creates the first user and the role that grants them everything.
     *
     * @param  SetupCommand  $command  The first user's profile and password.
     *                                 Carries no caller — there is none.
