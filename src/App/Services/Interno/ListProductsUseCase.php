 ...
 *
 * **The shape every list use case in this layer follows**, written out once here
 * so the others need only say how they differ:
 *
 *  1. **authorize**;
 *  2. **build the DQL** from the query's parameters, passed through untouched;
 *  3. **return what the runner returns**, unexamined.
 *
 ...
 * ({@see GetProductUseCase}), which does turn "nothing" into a 404.
 *
...
final readonly class ListProductsUseCase implements IListProductsUseCase
{
    ...
    /**
     * Authorizes, then hands the parameters to the DQL.
     *
