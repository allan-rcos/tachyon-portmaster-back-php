 ...
 */
/**
 * Builds the marker use cases, including the group registrar.
 *
 * None of them declares a permission: a marker is infrastructure for whoever
 * issued the value being flagged, not an action a user performs.
 *
 * See {@see FeatureProvider} for why the wiring is split this way and why
 * nothing here is memoized.
 *
 * @see FeatureProvider The base.
 * @see AuthProvider The refresh flow these serve.
...
{
    /**
     * Builds the {@see IRegisterMarkerGroupUseCase} implementation.
     *
