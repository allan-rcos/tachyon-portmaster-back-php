 ...
 */
/**
 * Builds the authentication use cases.
 *
 * Login, session validation and the deployment bootstrap — everything that runs
 * before a caller has been established. None declares a permission, because
 * there is nobody yet to check one against.
 *
 * See {@see FeatureProvider} for why the wiring is split this way and why
 * nothing here is memoized.
 *
 * @see FeatureProvider The base.
 * @see MarkerProvider The markers the refresh flow uses alongside these.
...
{
    /**
     * Builds the {@see ILoginUseCase} implementation.
     *
     * @copyright 2026 Tachyon
     */
    ...
    /**
     * Builds the {@see IValidateSessionUseCase} implementation.
     *
     * @copyright 2026 Tachyon
     */
    ...
    /**
     * Builds the {@see ISetupUseCase} implementation.
     *
