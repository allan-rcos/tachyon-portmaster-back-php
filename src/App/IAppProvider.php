 ...
 *
 * The re-exports are what keep the dependency rule enforceable rather than
 * merely stated: with this as the only thing the API is handed, a controller
 * *cannot* reach a repository, because it has no way to name one.
 *
 * @see \App\Interno\AppProvider The implementation.
 * @see \App\AppRegister What builds one.
 * @see \App\Interno\Provider\FeatureProvider Where the use cases are actually wired.
 *
 * @license {@link https://opensource.org/licenses/MIT MIT}
 * @copyright 2026 Tachyon
 */
interface IAppProvider
{
     ...
     *
     * @return ISequentialIdGenerator Produces ULIDs, which sort by creation
     *                                time.
     *
     * @copyright 2026 Tachyon
     *
     ...
     *
     * Unguessability is the requirement, not sortability: a token that could be
     * predicted from an earlier one would let anybody mint a session.
     *
